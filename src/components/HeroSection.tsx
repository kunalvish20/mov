...
const OverviewText: React.FC<{ overview: string }> = ({ overview }) => {
  ...
  if (overview.length <= maxLength) {
    return <p className="max-w-2xl">{overview}</p>;
  }

  return (
    <p className="max-w-2xl">
      {isExpanded ? overview : `${overview.slice(0, maxLength)}...`}
      <span 
                ...
                <Card className="border-none">
                  <CardContent className="flex md:h-screen h-[96vh] w-full p-0 text-white items-center justify-center relative">
                    ...
                    <div className="absolute md:left-20 left-10 md:bottom-[30%] bottom-[26%] md:w-[70%] w-[80%]">
                      ...
                      <OverviewText overview={item.overview || ""} />
